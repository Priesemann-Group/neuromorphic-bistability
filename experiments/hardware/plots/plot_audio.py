...
#    ax4.set_yscale("log", nonposy="clip")
    ...
    cs = ["#555555", "#AF5A50", "#000000", "#aaaaaa"]
    for i, _ in enumerate(durations.T):
        for ax in [ax0, ax1, ax2, ax3, ax4]:
            ax.axvline(durations[0,i], linestyle='--', color=cs[i], linewidth=0.5)
            ax.axvspan(*durations[1:,i], color=cs[i], linewidth=0.5, alpha=0.2)
