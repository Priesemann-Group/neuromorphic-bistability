...
if __name__ == "__main__":
    ...
    ax2.plot((bins[:-1] - bins[0]) * conf.speedup, activity_low)
    ax3.plot((bins[:-1] - bins[0]) * conf.speedup, activity_high)
    ...
    plt.savefig("plots/raster.pgf", transparent=True)
